 ...
 */
public class TagbanwaAlphabet extends AbstractAlphabet implements AlphabeticalCase
{
	/**
	 * Коды букв в Unicode.
	 */
	...
	/**
	 * Конструктор для {@code TagbanwaAlphabet}.
	 */
	public TagbanwaAlphabet()
	{
		super(TagbanwaAlphabet.LETTERS);
	}
