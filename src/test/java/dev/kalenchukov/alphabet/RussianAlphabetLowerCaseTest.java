...
{
	private static final Alphabetical ALPHABET = new RussianAlphabet.LowerCase();
	...
	public void testEquals()
	{
		...
		assertNotEquals(ALPHABET, new EnglishAlphabet.LowerCase());;

		assertEquals(ALPHABET, new RussianAlphabet.LowerCase());;
	}
