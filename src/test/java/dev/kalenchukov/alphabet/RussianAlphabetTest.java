...
public class RussianAlphabetTest
{
	...
	public void testGetLetters()
	{
		...
		assertEquals(Optional.of('И'), Optional.ofNullable(letters.get(18)));
		assertEquals(Optional.of('и'), Optional.ofNullable(letters.get(19)));
		...
		assertEquals(Optional.of('Ф'), Optional.ofNullable(letters.get(42)));
		assertEquals(Optional.of('ф'), Optional.ofNullable(letters.get(43)));
		assertEquals(Optional.of('Х'), Optional.ofNullable(letters.get(44)));
		assertEquals(Optional.of('х'), Optional.ofNullable(letters.get(45)));
		assertEquals(Optional.of('Ц'), Optional.ofNullable(letters.get(46)));
		assertEquals(Optional.of('ц'), Optional.ofNullable(letters.get(47)));
		assertEquals(Optional.of('Ч'), Optional.ofNullable(letters.get(48)));
		assertEquals(Optional.of('ч'), Optional.ofNullable(letters.get(49)));
		assertEquals(Optional.of('Ш'), Optional.ofNullable(letters.get(50)));
		assertEquals(Optional.of('ш'), Optional.ofNullable(letters.get(51)));
		assertEquals(Optional.of('Щ'), Optional.ofNullable(letters.get(52)));
		assertEquals(Optional.of('щ'), Optional.ofNullable(letters.get(53)));
		assertEquals(Optional.of('Ъ'), Optional.ofNullable(letters.get(54)));
		assertEquals(Optional.of('ъ'), Optional.ofNullable(letters.get(55)));
		assertEquals(Optional.of('Ы'), Optional.ofNullable(letters.get(56)));
		assertEquals(Optional.of('ы'), Optional.ofNullable(letters.get(57)));
		assertEquals(Optional.of('Ь'), Optional.ofNullable(letters.get(58)));
		assertEquals(Optional.of('ь'), Optional.ofNullable(letters.get(59)));
		assertEquals(Optional.of('Э'), Optional.ofNullable(letters.get(60)));
		assertEquals(Optional.of('э'), Optional.ofNullable(letters.get(61)));
		assertEquals(Optional.of('Ю'), Optional.ofNullable(letters.get(62)));
		assertEquals(Optional.of('ю'), Optional.ofNullable(letters.get(63)));
		assertEquals(Optional.of('Я'), Optional.ofNullable(letters.get(64)));
		assertEquals(Optional.of('я'), Optional.ofNullable(letters.get(65)));
	}
